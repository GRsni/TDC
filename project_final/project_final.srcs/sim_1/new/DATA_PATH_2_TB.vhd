...
begin
  ...
  begin
    ...
    CW_i <= "000000000000000100100";    -- LOAD_RAM_DATA_INTO_ALU_REG_B
    wait for 10 ns;
    ...
    CW_i <= "000110000000000000000";    -- BEZ_OP
    wait for 10 ns;
    
    CW_i <= "000011000110000000000";    -- BEZ_INST
    wait for 10 ns;
    ----------------------------------------------------
    
    
    ---------- INSTRUCTION ST [15], R7 ------------------
    ---------- 0010          1111 0111 ------------------
    CW_i <= "000000000000000000000";    -- RAM_INSTR_ADDR_UPDATE
    wait for 10 ns;
    ...
    CW_i <= "000000000001000000011";    -- ST_OP
    wait for 10 ns;
    -------------------------------------------------------
