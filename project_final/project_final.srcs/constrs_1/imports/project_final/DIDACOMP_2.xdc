...
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { FC_o }]; #IO_L20N_T3_A07_D23_14 Sch=led[14]
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { PUSH_i }]; #IO_L9P_T1_DQS_14 Sch=btnc
